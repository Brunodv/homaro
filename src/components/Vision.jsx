function Vision() {
  ...
  return (
    <div className="h-[250vh] mb-24 flex flex-col w-full md:flex-row md:h-[70vh] lg:w-[90%] lg:m-0 lg:m-auto xl:h-[250vh]">
      <div
        className="w-[70%] sm:w-[63%] mx-auto mt-200 mb-12 xl:m-auto xl: m-0"
