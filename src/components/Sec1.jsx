...
function Sec1() {
  ...
  return (
    <>
      <motion.div
        className="relative h-screen flex flex-col justify-between text-white bg-[url('/homaro/images/img2.png')] bg-cover bg-center z-1"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <motion.div
          className="absolute top-14 inset-0 bg-[url('/homaro/images/img1.png')] bg-cover bg-center z-2"
        ...
        <motion.div
          className="absolute inset-0 bg-[url('/homaro/images/vector.png')] top-32 left-48 bg-no-repeat bg-center mix-blend-overlay z-1"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
