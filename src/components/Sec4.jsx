...
function Sec4() {
  ...
  return (
    <div
      ref={ref}
      className="relative min-h-[800px] mt-24 sm:min-h-[1200px] md:min-h-[1200px] xl:min-h-[1600px] flex items-center justify-center xl:mt-10"
    >
      <div className="xl:flex xl:flex-col xl:m-0 xl:m-auto xl:items-center xl:justify-center">
        ...
        <div className="font-bold xl:font-normal mb-5 w-full gap-2 h-full flex flex-col xl:flex-row xl:w-[70%] xl:h-[900px] xl:gap-32">
          ...
          <div className="w-full flex items-center px-8 py-2 md:p-18 xl:p-2 xl:mt-20 xl:h-[800px]">
            <p className="text-xl sm:w-[100%] xl:w-[100%] sm:text-2xl xl:text-3xl text-gray-600 font-light w-[70%] leading-tight">
        ...
        <div className="xl:mb-12 lg:rounded-3xl lg:bg-gray-100 lg:m-0 lg:m-auto lg:flex lg:flex-row-reverse lg:w-[90%] xl:w-[77%]">
          <div className="flex items-start w-full h-full p-5 lg:w-[50%] lg:justify-center lg:mx-auto lg:py-6 xl:mr-10">
            <img
              src="images/img5.png"
          ...
          <div className="xl:justify-center lg:flex lg:items-center lg:jusfify-center lg:p-5 lg:w-[90%]">
            <p className="pb-12 text-gray-700 w-[84%] sm:w-[100%] text-xl sm:text-2xl px-12 py-4 lg:px-6 lg:text-2xl font-light xl:text-3xl 2xl:p-18">
